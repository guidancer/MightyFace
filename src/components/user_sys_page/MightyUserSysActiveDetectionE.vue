...
import { ref, reactive, onMounted, onUnmounted, onBeforeMount, getCurrentInstance } from 'vue';
...
const cropperdiv = ref(null)
const user_name = ref(null)
const user_email = ref(null)
const uploadFace = ref(null)
const file_to_upload = ref(null)
const preview = ref(null)
const active_detection_msgbox = ref(null)
...
const aggan_black = ref(null)
const aggan_blonde = ref(null)
const aggan_brown = ref(null)
const aggan_male = ref(null)
const aggan_young = ref(null)

const fgan_black = ref(null)
const fgan_blonde = ref(null)
const fgan_brown = ref(null)
const fgan_male = ref(null)
const fgan_young = ref(null)

const attgan_black = ref(null)
const attgan_blonde = ref(null)
const attgan_brown = ref(null)
const attgan_male = ref(null)
const attgan_young = ref(null)

const stargan_black = ref(null)
const stargan_blonde = ref(null)
const stargan_brown = ref(null)
const stargan_male = ref(null)
const stargan_young = ref(null)
...
function mightySocketMessage(event) {
    ...
    if (received_msg.sender_type == "active_detection_eval") {
        active_detection_msgbox.value.value = active_detection_msgbox.value.value + received_msg.sender_msg + "\n"
    } else if (received_msg.sender_type == "active_detection_eval_result") {
        const result = received_msg.sender_msg
        psnr.value.innerText = result.psnr
        ssim.value.innerText = result.ssim
        l2.value.innerText = result.l2
        l1.value.innerText = result.l1

        aggan_black.value.innerText = (100.00 - result.aggan_black[0]) + '%' + '\n' + (100.00 - result.aggan_black[1]) + '%' + '\n' + result.aggan_black[2] + '%'
        aggan_blonde.value.innerText = (100.00 - result.aggan_blonde[0]) + '%' + '\n' + (100.00 - result.aggan_blonde[1]) + '%' + '\n' + result.aggan_blonde[2] + '%'
        aggan_brown.value.innerText = (100.00 - result.aggan_brown[0]) + '%' + '\n' + (100.00 - result.aggan_brown[1]) + '%' + '\n' + result.aggan_brown[2] + '%'
        aggan_male.value.innerText = (100.00 - result.aggan_male[0]) + '%' + '\n' + (100.00 - result.aggan_male[1]) + '%' + '\n' + result.aggan_male[2] + '%'
        aggan_young.value.innerText = (100.00 - result.aggan_young[0]) + '%' + '\n' + (100.00 - result.aggan_young[1]) + '%' + '\n' + result.aggan_young[2] + '%'

        fgan_black.value.innerText = (100.00 - result.fgan_black[0]) + '%' + '\n' + (100.00 - result.fgan_black[1]) + '%' + '\n' + result.fgan_black[2] + '%'
        fgan_blonde.value.innerText = (100.00 - result.fgan_blonde[0]) + '%' + '\n' + (100.00 - result.fgan_blonde[1]) + '%' + '\n' + result.fgan_blonde[2] + '%'
        fgan_brown.value.innerText = (100.00 - result.fgan_brown[0]) + '%' + '\n' + (100.00 - result.fgan_brown[1]) + '%' + '\n' + result.fgan_brown[2] + '%'
        fgan_male.value.innerText = (100.00 - result.fgan_male[0]) + '%' + '\n' + (100.00 - result.fgan_male[1]) + '%' + '\n' + result.fgan_male[2] + '%'
        fgan_young.value.innerText = (100.00 - result.fgan_young[0]) + '%' + '\n' + (100.00 - result.fgan_young[1]) + '%' + '\n' + result.fgan_young[2] + '%'

        attgan_black.value.innerText = (100.00 - result.attgan_black[0]) + '%' + '\n' + (100.00 - result.attgan_black[1]) + '%' + '\n' + result.attgan_black[2] + '%'
        attgan_blonde.value.innerText = (100.00 - result.attgan_blonde[0]) + '%' + '\n' + (100.00 - result.attgan_blonde[1]) + '%' + '\n' + result.attgan_blonde[2] + '%'
        attgan_brown.value.innerText = (100.00 - result.attgan_brown[0]) + '%' + '\n' + (100.00 - result.attgan_brown[1]) + '%' + '\n' + result.attgan_brown[2] + '%'
        attgan_male.value.innerText = (100.00 - result.attgan_male[0]) + '%' + '\n' + (100.00 - result.attgan_male[1]) + '%' + '\n' + result.attgan_male[2] + '%'
        attgan_young.value.innerText = (100.00 - result.attgan_young[0]) + '%' + '\n' + (100.00 - result.attgan_young[1]) + '%' + '\n' + result.attgan_young[2] + '%'

        stargan_black.value.innerText = (100.00 - result.stargan_black[0]) + '%' + '\n' + (100.00 - result.stargan_black[1]) + '%' + '\n' + result.stargan_black[2] + '%'
        stargan_blonde.value.innerText = (100.00 - result.stargan_blonde[0]) + '%' + '\n' + (100.00 - result.stargan_blonde[1]) + '%' + '\n' + result.stargan_blonde[2] + '%'
        stargan_brown.value.innerText = (100.00 - result.stargan_brown[0]) + '%' + '\n' + (100.00 - result.stargan_brown[1]) + '%' + '\n' + result.stargan_brown[2] + '%'
        stargan_male.value.innerText = (100.00 - result.stargan_male[0]) + '%' + '\n' + (100.00 - result.stargan_male[1]) + '%' + '\n' + result.stargan_male[2] + '%'
        stargan_young.value.innerText = (100.00 - result.stargan_young[0]) + '%' + '\n' + (100.00 - result.stargan_young[1]) + '%' + '\n' + result.stargan_young[2] + '%'
    }
}
const fetchCustom = async (file_form_data) => {
    try {
        await axios.post(
            "/user/active_detection_eval_custom", file_form_data, {
            headers: {
...
const fetchDefault = async (file_form_data) => {
    try {
        await axios.post(
            "/user/active_detection_eval_default", file_form_data, {
            headers: {
                "Content-Type": "multipart/form-data"
            },
        }).then(res => {
...
function mightyDefault(event) {
    const file_form_data = new FormData()
    fetchDefault(file_form_data)
}
...
function mightyCustom(event) {
    let input = document.createElement('input')
    input.type = 'file'
    input.accept = '.zip'; // 限制选择的文件类型为 .pdf, .png, .zip, .jpg
    input.style.display = 'none'
    document.body.appendChild(input)
    input.click();
    input.onchange = (e) => {
        const file = e.target.files[0] // 获取文件对象
        file_to_upload.value = file
        const file_form_data = new FormData()
        file_form_data.append('file', file_to_upload.value)
        fetchCustom(file_form_data)
...
<template>
    ...
    <div class="flex w-full h-full flex-row">
        ...
        <aside class="h-full m-0.5 flex-col transition-transform" style="width: 41.5%;">
            <div class="m-1 w-full bg-blue-100 rounded-md">
                <div class="w-1/3 inline-block"></div>
                <div class="w-1/3 inline-block mb-32">
                    <span
                        class="mt-24 text-base font-semibold text-gray-600 flex items-center justify-center">使用已有的数据集进行评估</span>
                    <div class="mt-3 bg-white rounded-2xl shadow-xl">
                        <img @click="mightyDefault" class="w-auto h-auto  rounded-2xl" src="../../assets/intro.png" />
                    </div>
                    <span
                        class="mt-24 text-base font-semibold text-gray-600 flex items-center justify-center">上传构建好的数据集进行评估</span>
                    <div class="mt-2.5 bg-white rounded-2xl shadow-xl">
                        <input class="hidden" type="file" ref="uploadFace" accept=".png,.jpg" />
                        <img @click="mightyCustom" class="w-auto h-auto rounded-2xl" src="../../assets/zips.jpg" />
                    </div>
                </div>
                <div class="w-1/3 inline-block"></div>
            </div>
        </aside>
        <aside class="h-full m-0.5 flex-col transition-transform" style="width: 41%;">
            <div class="m-1 w-full bg-pink-100 rounded-md">
                <div class="w-1/12 inline-block"></div>
                <div class="w-10/12 inline-block">
                    <span
                        class="mt-2 text-3xl font-semibold text-gray-600 flex items-center justify-center">主动取证提取率数据预览</span>
                    <!-- 表格 -->
                    <div class="mt-2 bg-pink-100">
                                ...
                                <table class="w-full text-md text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4" ref="aggan_black">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="aggan_blonde">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="aggan_brown">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="aggan_male">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="aggan_young">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4" ref="fgan_black">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="fgan_blonde">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="fgan_brown">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="fgan_male">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="fgan_young">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4" ref="attgan_black">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="attgan_blonde">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="attgan_brown">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="attgan_male">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="attgan_young">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <td class="px-6 py-4" ref="stargan_black">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="stargan_blonde">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="stargan_brown">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="stargan_male">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                                            <td class="px-6 py-4" ref="stargan_young">
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                                <h1>暂无</h1>
                                            </td>
                    ...
                    <span
                        class="mt-2 text-3xl font-semibold text-gray-600 flex items-center justify-center">图像视觉质量评估数据预览</span>
                    <!-- 表格 -->
                    <div class="mt-3 mb-2 bg-pink-100">
                        <div class="w-full inline-block">
                            <div class="relative overflow-x-auto">
                                <table class="w-full text-md text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <thead
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            <th scope="row" ref="psnr"
                                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                暂无
                                            </th>
                                            <td class="px-6 py-4" ref="ssim">
                                                暂无
                                            </td>
                                            <td class="px-6 py-4" ref="l2">
                                                暂无
                                            </td>
                                            <td class="px-6 py-4" ref="l1">
                                                暂无
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <textarea id="message" rows="12" ref="active_detection_msgbox"
                        class="block p-2.5 w-full text-md h-64 mb-1 text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
